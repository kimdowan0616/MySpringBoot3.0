...
//        }
    ...
    public User getUserByEmail(@PathVariable String email) {
        return userRepository.findByEmail(email).orElseThrow(() -> new BusinessException("요청하신 email에 해당하는 유저가 없습니다", HttpStatus.NOT_FOUND));
    }
    ...
    @PutMapping("/{id}")    // PathVariable 변수랑 PutMapping 변수랑 변수명이 같아야 한다.
